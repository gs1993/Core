    ...
    public class InitiatePaymentCommandHandler : IRequestHandler<InitiatePaymentCommand, Result<string>>
    {
        ...
        public async Task<Result<string>> Handle(InitiatePaymentCommand request, CancellationToken cancellationToken)
        {
            ...
            var order = await _context.Orders
                ...
                .SingleOrDefaultAsync(x => x.Id == request.OrderId && x.OrderState.Value == Entities.Product.OrderStateEnum.Created, cancellationToken: cancellationToken);
            if (order == null)
        ...
        private static TransactionDto CreateTransactionDto(Entities.Product.Order order)
        {
            return new TransactionDto
            {
                ...
                Language = "pl",
                Products = order.OrderItems.Select(x => new Shared.PaymentMethods.Dtos.ProductDto
                {
                    Name = x.Product.Name,
                    Quantity = x.Quantity,
