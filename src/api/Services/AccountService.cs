...
namespace WebApi.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public AuthenticateResponse Authenticate(AuthenticateRequest model, string ipAddress)
        {
            ...
            return CreateFromModel(account, jwtToken, refreshToken.Token);
        }
        ...
        public void Register(RegisterRequest model, string origin)
        {
            ...
            var role = _context.Accounts.Any() ? Domain.Accounts.Entities.Role.User : Domain.Accounts.Entities.Role.Admin;
        ...
        public IEnumerable<AccountResponse> GetAll()
        {
            ...
            return accounts.Select(x => CreateFromModel(x));
        }

        public AccountResponse GetById(long id)
        {
            var account = GetAccount(id);
            return CreateFromModel(account);
        }
        ...
        public void ChangeRole(long id, Domain.Accounts.Entities.Role role)
        {
            var account = GetAccount(id);
        ...
        {
            var refreshTokenResult = Domain.Accounts.Entities.RefreshToken.Create(
        ...
        private static AccountResponse CreateFromModel(Account account)
        {
            if (account == null)
        ...
        private static AuthenticateResponse CreateFromModel(Account account, string jwtToken, string refreshToken)
        {
            if (account == null)
                throw new ArgumentNullException(nameof(account));
